    ...
    <div class="flex h-screen bg-gray-200">
        <aside id="sidebar" class="w-64 hidden z-10  md:flex flex-col bg-gray-800 text-white">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-2.5 text-gray-300 {{ request()->is('admin/dashboard') ? 'bg-gray-900' : 'hover:bg-gray-700' }} rounded-lg">
                ...
                <a href="{{ route('admin.manageposts') }}"
                ...
                <a href="{{ route('admin.manageusers') }}"
                    ...
                    <svg class="w-6 h-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197m0 0A5.975 5.975 0 0112 13a5.975 5.975 0 013 1.803M15 21a9 9 0 00-9-5.197" />
                    </svg>
                    Users
                </a>
