<div class="featured-posts container mx-auto p-4 rounded-lg">
    ...
    <div class="mt-5 md:mt-7 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="p-4 flex-1 flex flex-col gap-3">
                ...
                <div class="pt-2 flex mt-auto">
                    <a href="{{ route('post.details', $post->id) }}"
                        ...
                        <span class="absolute flex items-center justify-center w-full h-full text-rose-500 transition-all duration-300 transform group-hover/button:translate-x-full ease">
                            See more
                        </span>
